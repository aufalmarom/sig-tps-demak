...
<h1 class="h3 mb-0 text-gray-800">Data Presiden</h1>
</div>
...
<div class="card-body">
    ...
    <h5><b>Suara Paslon 1: Ir. H. Joko Widodo - Prof. Dr. (H.C) KH. Ma'aruf Amin</b></h5>
    <p>{{$data->paslon_1}}</p>
    <br>

    <h5><b>Suara Paslon 2: H. Prabow Subianto - H. Sandiaga Salahudin Uno</b></h5>
    <p>{{$data->paslon_2}}</p>
    <br>
